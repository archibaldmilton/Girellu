function init_sol_custom_config()
	...
	SOL__set_config("weather", "HDR_multiplier", 0.85)
...
function update_sol_custom_config(dt)
	...
	ac.setPpTonemapFilmicContrast(0.2 + (0.1 * night_compensate(0)))--0.2 day 0.3 night
	...
	SOL__set_config("nerd__stars_adjust", "Exponent", 0.6, true)
end