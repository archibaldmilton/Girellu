function init_sol_custom_config()
	...
	SOL__set_config("gfx", "reflections_saturation", 0.4)
	SOL__set_config("gfx", "reflections_brightness", 0.4)
...
local gamma = 0.8
	...
	--ppfilter + dynamics
	SOL__set_config("nerd__speculars_adjust","Level",1.0)
	SOL__set_config("pp", "brightness_sun_link", 0.3)
	ac.setPpTonemapFilmicContrast(0.95)
	SOL__set_config("pp", "contrast", 0.95)
	ac.setPpBrightness( 0.70 * day_compensate(2.5) )
	SOL__set_config("pp", "saturation", 1.2)
