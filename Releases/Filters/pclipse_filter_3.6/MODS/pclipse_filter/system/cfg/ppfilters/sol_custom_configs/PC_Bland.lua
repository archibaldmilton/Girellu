function init_sol_custom_config()
	...
	SOL__set_config("sun", "dazzle_strength", 0.3)
	...
	SOL__set_config("gfx", "reflections_saturation", 0.5)
	SOL__set_config("gfx", "reflections_brightness", 1.4)
	...
	--ambient
	SOL__set_config("ambient", "sun_color_balance", 0.55)
...
function update_sol_custom_config()
		...
		SOL__set_config("nerd__csp_lights_adjust", "bounced_day", 0.5)
		SOL__set_config("nerd__csp_lights_adjust", "bounced_night", 1.7)
		SOL__set_config("nerd__csp_lights_adjust", "emissive_night", 2.1)
		SOL__set_config("nerd__csp_lights_adjust", "emissive_day", 0.8)
...
local gamma = 1
	...
	--ppfilter + dynamics
	SOL__set_config("nerd__speculars_adjust","Level",0.95)
	SOL__set_config("pp", "brightness_sun_link", 0.3)
	ac.setPpTonemapFilmicContrast(0.95)
	SOL__set_config("pp", "contrast", 0.95)
	ac.setPpBrightness( 1.4 * day_compensate(1.9) )
