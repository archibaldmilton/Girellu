...
function update_sol_custom_config(dt)
	...
	ac.setPpTonemapFilmicContrast(0.03 + (0.42 * night_compensate(0)))
	...
	SOL__set_config("nerd__csp_lights_adjust", "bounced_night", 1 + 0.7*night_compensate(0), true)--adjust headlight brightness
end