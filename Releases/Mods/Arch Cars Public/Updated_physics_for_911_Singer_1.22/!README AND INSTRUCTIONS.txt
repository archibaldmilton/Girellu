...
The data.acd file is intended as an update to the Porsche 911 Singer resource by Ben O' Bro.

Installation instructions

1.
Download original resource from 
https://www.racedepartment.com/downloads/porsche-911-singer.29318/
and install.

2.
Copy 'content' folder to AC directory.
