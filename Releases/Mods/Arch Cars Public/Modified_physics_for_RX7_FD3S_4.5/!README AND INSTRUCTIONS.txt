...
Drift : KS RX7 Tuned and Tuned sound
...
5. use CM to Replace Sound (Bottom Right Icon) and select the Kunos RX7
IMAGE_2.png

6. Drag and drop "extensions" folder into AC directory.
