...
Includes:
AE86 1600GT-APEX Sprinter Trueno
AE86 1600GTV Sprinter Trueno
AE86 Sprinter Trueno Drift
AE86 Sprinter Trueno S1
AE86 Sprinter Trueno S2
...
The data.acd file is intended as a replacement used alongside the KS AE86 visuals
...
GT-APEX : KS AE86 and KS AE86 Tuned sound
GTV : KS AE86 and KS AE86 Tuned sound
S1 : KS AE86 and KS AE86 Tuned sound
S2 : KS AE86 and KS AE86 Tuned sound
Drift: KS AE86 Drift and KS AE86 Tuned sound

Tuned sound is used due to 8000RPM rev limits: stock car sound will not work properly above standard RPM limit.

Installation instructions

1.
make 5 new folders on content\cars:
arch_toyota_ae86_sprinter_trueno_gtapex_1983
arch_toyota_ae86_sprinter_trueno_gtv_1983
arch_toyota_ae86_sprinter_trueno_1983_s1
arch_toyota_ae86_sprinter_trueno_1983_s2
arch_toyota_ae86_sprinter_trueno_1983_drift

2.
copy from folder "ks_toyota_ae86"
all these files to the new created folders:
arch_toyota_ae86_sprinter_trueno_gtapex_1983
arch_toyota_ae86_sprinter_trueno_gtv_1983
arch_toyota_ae86_sprinter_trueno_1983_s1
arch_toyota_ae86_sprinter_trueno_1983_s2
...
Repeat process from folder "ks_toyota_ae86_drift" for:
arch_toyota_ae86_sprinter_trueno_1983_drift

4. use CM to Replace Sound (Bottom Right Icon), suggested to use KS AE86 Tuned or your own
IMAGE_2.png

The .bank file must correspond to the entries in the GUIDs and be the exact same as the car's folder name.
